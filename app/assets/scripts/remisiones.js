    ...
    $("#frm-comprobante").submit(function(){
        ...
        }else
        {
            $.ajax({
                ...
                success: function (r) { 
                    window.top.location.href = '../app/views/default/dashboard.php?m=bW9kdWxlL3JlbWlzaW9uZXMucGhw&pagid=UEFHLTEwMDAyMA==&alert=true&alty=c3VjY2Vzcw==&almsn=UGVyZmVjdG8hIHR1IHJlZ2lzdHJvIHNlIGhhIGd1YXJkYWRvIGNvcnJlY3RhbWVudGUuIA=='
