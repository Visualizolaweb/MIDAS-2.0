...
<form id="frm-comprobante" method="post" action="?c=comprobante&a=GuardarRemision">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <fieldset>
                <h2><i class="fa fa-plus"></i> NUEVA REMISION <span style="float:right">REMISION Nº <?php echo $_REQUEST["facnum"]; ?> </span></h2>
                <div class="row">
            ...
            <div style="text-align:right">
              <button class="btn btn-primary" type="button" id="btn-facpago" name="accion" value="facturar">Generar Remisión</button>
...
<div class="row">
  ...
  <div class="col-xs-2">
    ...
    <li class="list-group-item seccion_impuestos">
        <div class="row text-right">
            <div class="col-xs-10 text-right">
                Impuestos<br> <small>(Importante: Los impuestos se encuentran discriminados al momento de generar la factura)</small>
            </div>
...
<script src="assets/scripts/remisiones.js"></script>
