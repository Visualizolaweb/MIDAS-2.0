<?php
  ...
  $configuracion_factura = Gestion_Factura::ReadConf($_usu_sed_codigo);
...
if($_REQUEST["e"] == 3){
  ...
  $pdf->SetTextColor(110,110,110);
  $pdf->SetFont('','B',13);
  $pdf->Cell(90,8,utf8_decode('FACTURA Nº '.strtoupper($configuracion_factura["fac_prefijo"]).$dato_factura["fac_numero"]),0,0,"R",false);
  $pdf->SetXY(116, 44);
  $pdf->SetFont('','',10);
