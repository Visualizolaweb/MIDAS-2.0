										   ...
										   <label class="control-label">Dirección de Residencia</label>
											...
											<div class="form-group">
										 	...
										 	<div class="form-group">
													...
													<div id="drop-city">
 														<input type="text" class="form-control"  id="txt-ciudad" name="txt-ciudad"    >
													 </div>
											</div>
							...
							<div class="panel-body">
								...
								<div class="form-group">
										<label class="control-label">Teléfono (fijo)</label>
										 <input name="txt_cli_telefono" id="txt-phone" type="text" class="form-control" parsley-trigger="change">
								</div>

								<div class="form-group">
										 <label class="control-label">Celular</label>
										 <input name="txt_cli_celular" id="txt-cel" type="text" class="form-control" parsley-trigger="change"  parsley-required="true">
							 	</div>
						  ...
						  -->
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<select onclick='seleccion(this)' style='position: absolute; visibility: visible; width: 85%; height: 36px; z-index: 3; margin-top: 56px; left: 20px; border: 1px solid#ddd;' id="clientes_data">
									<option value="">- Selecciona una opción - </option>
									</select>
									<input name="txt_cli_referido"  type="text" class="form-control" onkeyup="buscarCli(this)" parsley-trigger="change"   placeholder="" >
								</div>
							</div>
					</section>
						...
						<section class="panel corner-flip">
								...
								<div class="panel-body">
									<div class="btn-group left">
											...
											<div class="row">
											<input type="hidden" name="txt_cli_tipo_usuario" value="Fijo">
					 							<div class="col-md-4 bg-cortesia "><i class="fa fa-gift"></i><h4>ADQUIRIR CORTESIA</h4></div>
												<div class="col-md-4 bg-planes"><i class="fa fa-odnoklassniki"></i><h4>ADQUIRIR PLAN</h4></div>
												<div class="col-md-4 bg-volver col-md-offset-3"><i class="fa fa-undo"></i><h4>Volver</h4></div>
