        ...
        <div class="panel">
          <header class="panel-heading">
            ...
            <?php	if($row_permiso["per_C"]==1){?>
                    <a href="dashboard.php?m=<?php echo base64_encode("module/proveedores_nuevo.php");?>" class="btn btn-primary"><i class="fa fa-plus"></i> Nuevo Proveedor</a>
    				<?php } ?>
          ...
          <div class="panel-body">
            ...
            <table id="datagrid" class="display" cellspacing="0" width="100%">
              ...
              <tbody>
                <?php
                      ...
                      $stmt = Gestion_Proveedores::ReadAll();
                      ...
                      foreach($stmt as $row){
                        ...
                        echo "<tr>";
                          echo "<td style='border-left: 1px solid #ddd'>$row[2]</th>";
                          echo "<td>$row[1]</td>";
                          echo "<td>$row[12]</td>";
                          echo "<td>$row[13]</td>";
                          echo "<td>";
                							  if($row_permiso["per_R"]==1){
                								    echo " <a href='dashboard.php?m=".base64_encode("module/proveedores_detalle.php")."&pid=".base64_encode($row[0])."' type='button' class='btn btn-detalle btn-datagrid'><i class='fa fa-search-plus'></i> </a> ";
                							  }

                								if($row_permiso["per_U"]==1){
                							      echo "<a href='dashboard.php?m=".base64_encode("module/proveedores_editar.php")."&pid=".base64_encode($row[0])."' type='button' class='btn btn-detalle btn-datagrid'><i class='fa fa-pencil'></i> </a>";
                							  }
            ...
            <div id="md-effect" class="modal fade" tabindex="-1" data-width="450">
              ...
              <div class="modal-body">
                ...
                <form action="../../controller/crud_proveedores.controller.php" method="post">
                  <input type="hidden" id="codigoid" name="codigoid" value="" readonly/>
                  <p>Esta seguro que desea eliminar el Proveedor <span class="label bg-warning" id="innertext"></span></p>
