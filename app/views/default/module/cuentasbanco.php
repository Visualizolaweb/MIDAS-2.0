        ...
        <div class="panel">
          <header class="panel-heading">
            ...
            <?php	if($row_permiso["per_C"]==1){
    				      echo '<a href="dashboard.php?m='.base64_encode("module/cuentasbanco_nuevo.php").'&pagid='.$pagid.'" class="btn btn-primary"><i class="fa fa-plus"></i> Nueva Cuenta</a>';
    				}?>
          ...
          <div class="panel-body">
            ...
            <table id="datagrid" class="display" cellspacing="0" width="100%">
              ...
              <tbody>
                <?php
                      ...
                      $stmt = Gestion_Cuentasbanco::ReadAll($_usu_sed_codigo);
                      ...
                      foreach($stmt as $row){
                          ...
                          echo "<td>".$row["ban_banco"]."</td>";
                          echo "<td>$row[3]</td>";
                          echo "<td>".$row[4]."</td>";
                          echo "<td style='text-align:center'>$".number_format($row[5])."</td>";
                          echo "<td>";



            						  if($row_permiso["per_U"]==1){
            							  echo " <a href='dashboard.php?m=".base64_encode("module/cuentasbanco_edita.php")."&pid=".base64_encode($row[0])."&pagid=$pagid' type='button' class='btn btn-edit btn-datagrid'><i class='fa fa-pencil'></i> </a>";
            						  }
            ...
            <div id="md-effect" class="modal fade" tabindex="-1" data-width="450">
              ...
              <div class="modal-body">
                ...
                <form action="../../controller/crud_cuentasbanco.controller.php" method="post">
                  <input type="hidden" id="codigoid" name="codigoid" value="" readonly/>
                  <p>Esta seguro que desea eliminar la cuenta? <span class="label bg-warning" id="innertext"></span></p>
