...
$icono = Gestion_Menu::Load_icon($row_paginas[0]);
  ...
  $data = Gestion_Sedes::ReadbyID(base64_decode($_GET["pid"]));
      ...
      <div class="col-lg-12">
        <div class="panel">
          <header class="panel-heading">
            <h3><strong>ACTUALIZAR</strong>  LABORATORIO</h3>
          </header>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="txt_sed_codigo" type="text" class="form-control" readonly value="<?php echo $data[0];?>">
                        </div>
                        <div class="row">
                          <div class="col-md-8">
                            ...
                            <div class="form-group">
                              ...
                              <input name="txt_sed_nombre"  type="text" class="form-control" parsley-trigger="change" value="<?php echo $data["sed_nombre"];?>" parsley-required="true">
                            </div>
                          </div>
                        ...
                        <div class="form-group">
                          <label class="control-label">Teléfono</label>
                            <input name="txt_sed_telefono"  type="text" class="form-control"   parsley-trigger="change" value="<?php echo $data["sed_telefono"];?>" parsley-required="true">
                        </div>

                        <div class="form-group">
                          <label class="control-label">Email <span>(Opcional)</span></label>
                            <input name="txt_sed_email"  type="text" class="form-control" parsley-type="email"value="<?php echo $data["sed_email"];?>" parsley-trigger="change">
                        </div>
                            ...
                            <label class="control-label">Dirección</label>
                             ...
                             <div class="row">
                                   ...
                                   <div class="input-group input-group-btn">
                                       <input name="laboratorio_direccion" id="laboratorio_direccion" type="text" readonly class="form-control" value="<?php echo $data["sed_direccion"];?>">
                        ...
                        <div class="form-group">
                            ...
                            <select name="txt_cli_pais" id="countries_states1" class="form-control bfh-countries" data-country="<?php echo $data["sed_pais"]; ?>" data-filter="true"></select>
                        </div>

                        <div class="form-group">
                            <label class="control-label">Departamento</label>
                            <select id="countries_states2" name="txt_cli_dpto" class="form-control bfh-states" data-country="countries_states1" data-state="<?php echo $data["sed_departamento"] ?>" parsley-trigger="change"  parsley-required="true"> </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div id="drop-city">
                              ...
                              $ciudades = Gestion_Localidad::Read_City_byState($data["sed_departamento"]);
                              ?>
                              <select class="form-control" id="txt-ciudad" name="txt_cli_ciudad" >
                                <?php
                                  foreach($ciudades as $ciudad){

                                    if($data["sed_ciudad"] == $ciudad[1]){
                                      $select = "selected";
                                    }else{
                                      $select = "";
                                    }
                       ...
                       <div class="form-group">
                          <button type="submit" class="btn btn-success right " name="btn_continue" value="modificar">Modificar el laboratorio</button>
