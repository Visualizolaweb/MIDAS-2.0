      ...
      <div class="col-lg-8">
        <div class="panel">
          <header class="panel-heading">
            <h3><strong>DETALLE</strong> NOTA DÉBITO </h3>
          </header>
          ...
          <div class="panel-body">
              ...
              <?php
                ...
                $row = Gestion_NotaDebito::Notas_Debito_Detalle(base64_decode($_GET["pid"]));
              ...
              ?>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                          <label class="control-label"><strong class="text-primary">Nota Débito N° :</strong></label>
                          <span><?php echo $row["nota_numero"];?></span>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <span><?php echo $row["nota_fecha"];?> </span>
                        </div>

                        <div class="form-group">
                          <label class="control-label"><strong class="text-primary">Total:</strong></label>
                          <span>$ <?php echo number_format($row["nota_total"]);?> </span>
                        </div>
                  ...
                  <table  class="display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <?php
                            $stmt = Gestion_NotaDebito::Notas_Debito_Detalle_prod($row["nota_numero"]);
                            $pageparams = basename($_SERVER["REQUEST_URI"]);

                            $total = 0;
                            foreach($stmt as $row){
                                $subtotal = $row["det_cantidad"] * $row["prod_valor"];
                                $total = $total + $subtotal;
                              echo "<tr>";
                                echo "<td style='border-left: 1px solid #ddd'>".$row['prod_nombre']."</td>";
                                echo "<td>".$row["det_cantidad"]."</td>";
                                echo "<td> ".$row["det_observaciones"]."</td>";
                  ...
                  <div class="row">
                   <div class="col-md-12">
                      <div class="form-group">
                         <a href="dashboard.php?m=<?php echo base64_encode("module/nota_debito.php");?>&pagid=<?php echo base64_encode("PAG-100021");?>" class="btn btn-info btn-block ">Volver</a>
                      </div>
                  </div>
                </div>
              </form>
