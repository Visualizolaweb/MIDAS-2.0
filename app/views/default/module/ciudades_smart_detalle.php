      ...
      <div class="col-lg-8">
        <div class="panel">
          <header class="panel-heading">
            <h3><strong>DETALLE</strong> DE LAS CIUDADES BESMART </h3>
          </header>
              ...
              ?>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                       ...
                       <div class="form-group">
                          <a href="dashboard.php?m=<?php echo base64_encode("module/ciudades_smart.php");?>&pagid=<?php echo base64_encode("PAG-10069");?>" class="btn btn-info btn-block ">Volver</a>
                       </div>
                    </div>
                  </div>
